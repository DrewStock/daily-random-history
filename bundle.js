	...
	var App = function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            _axios2.default.get('http://history.muffinlabs.com/date').then(function (res) {
	                var historyEvents = res.data;
	                console.log(historyEvents);
	                _this2.setState({
	                    historyEvents: historyEvents
	                });
	                var wtf = [_this2.state.historyEvents.data.Events];
	                console.log(wtf[0]);
	            });
	        }
	    }, {
